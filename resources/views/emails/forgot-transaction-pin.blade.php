                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('assets/images/application/logo.jpg') }}" alt="image"
                                                                            title="image"
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                ...
                                                                <strong>Email Confirmation</strong></h1>
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_heading_2" style="font-family:'Raleway',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:25px 60px 10px;font-family:'Raleway',sans-serif;"
                                                            align="left">

                                                            <h1 class="v-font-size"
                                                                style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 16px; font-weight: 400;">
                                                                Dear customer, thank you for choosing Bill Vault App.<br /><br />We received a request to change account transaction pin. Please make use of the code below on the bill vault app.
                                                            </h1>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <table id="u_content_button_1" style="font-family:'Raleway',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:14px 10px 22px;font-family:'Raleway',sans-serif;"
                                                            align="left">

                                                            <!--[if mso]><style>.v-button {background: transparent !important;}</style><![endif]-->
                                                            <div align="center">
                                                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://www.unlayer.com" style="height:51px; v-text-anchor:middle; width:197px;" arcsize="49%"  stroke="f" fillcolor="#fdb441"><w:anchorlock/><center style="color:#000000;"><![endif]-->
                                                                <a class="v-button v-size-width v-font-size"
                                                                    style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #000000; background-color: #fdb441; border-radius: 25px;-webkit-border-radius: 25px; -moz-border-radius: 25px; width:34%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                                                                    <span style="display:block;padding:10px 20px;line-height:120%;">
                                                                    <strong><span style="line-height: 31.2px; font-size: 26px;">{{ $data['token'] }}</span></strong></span>
                                                                </a>
                                        ...
                                        <div
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-font-size"
                                                                ...
                                                                <p style="text-align:center;font-size: 14px; line-height: 170%;">Kindly ignore this message if you didn't request a code.<br>Also change your password for more security if you did not make this request.</p>
                                                            </div>
                                            ...
                                            <table id="u_content_social_1" style="font-family:'Raleway',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:18px 10px 10px;font-family:'Raleway',sans-serif;"
                                                            align="left">
                                                            ...
                                                            <div align="center">
                                                                <div style="display: table; max-width:163px;">
                                                                    ...
                                                                    <table align="left" border="0"
                                                                        ...
                                                                        width="32" height="32"
                                                                        style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 9px">
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://twitter.com/unlayerapp"
                                                                                        title="Twitter"
                                                                                        target="_blank">
                                                                                        <img src="{{ asset('assets/images/image-6.png') }}"
                                                                                            alt="Twitter"
                                                                                            title="Twitter"
                                                                                            width="32"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://www.instagram.com/unlayer_official/"
                                                                                        title="Instagram"
                                                                                        target="_blank">
                                                                                        <img src="{{ asset('assets/images/image-5.png') }}"
                                                                                            alt="Instagram"
                                                                                            title="Instagram"
                                                                                            width="32"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td class="v-container-padding-padding"
                                                                        ...
                                                                        <div class="v-font-size"
                                                                            style="font-size: 14px; line-height: 170%; text-align: center; word-wrap: break-word;">
                                                                            <p style="font-size: 14px; line-height: 170%;">Copyright &copy; {{ date('Y') }} Billvault App</p>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
