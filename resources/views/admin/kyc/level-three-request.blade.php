                                        ...
                                        <tbody>
                                            @foreach ($list as $k => $ls)
                                                <tr>
                                                    ...
                                                    <td>{{ $ls->house_address }}</td>
                                                    <td><a target="_blank" href="{{asset('storage/app/public/'. $ls->utility_bill)}}"> <img width="100px" height="100px" src="{{asset('storage/app/public/'.$ls->utility_bill)}}"> </a></td>
                                                    <td>
                                                        @if($ls->status == 0)
                ...
                <div id="approveModal" class="modal fade" tabindex="-1" aria-labelledby="approveModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form id="approveForm" method="POST" action="{{ route('admin.kyc.approve-level-three') }}">
                                @csrf
                ...
                <div id="rejectModal" class="modal fade" tabindex="-1" aria-labelledby="rejectModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form id="rejectForm" method="POST" action="{{ route('admin.kyc.reject-level-three') }}">
                                @csrf
                                <div class="modal-body">
