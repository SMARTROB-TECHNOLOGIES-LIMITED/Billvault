            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Sell Gift Card transaction</h2>
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}" class="breadcrumb-link">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('admin.customer.list') }}" class="breadcrumb-link">Sell Gift Card Transactions</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row pb-3">
                <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <h4 class="my-2">Sell Gift Card Transactions</h4>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $transactionData['network'] ."-". $transactionData['country']}}</td>
                                            ...
                                            <td>
                                                <form action="/admin/transaction-log/{{$transaction->id}}/decline" method="POST">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button class="btn btn-sm btn-danger }}"> <i class="fa fa-cancel"></i> </button>
                                                </form>
                                                <button class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#editNetworkModal{{ $transaction->id }}">
                                                    <i class="fa fa-check"></i>
                                                </button>
                                                <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#image{{ $transaction->id }}">
                                                    <i class="fa fa-eye"></i>
                                                </button>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade " id="image{{ $transaction->id }}" tabindex="-1" aria-labelledby="editNetworkModalLabel{{ $transaction->id }}" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editNetworkModalLabel{{ $transaction->id }}"> Transaction Image(s)</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                        @csrf
                                                        @method('PATCH')
                                                        <div class="modal-body row">
                                                            @foreach ($transactionData['transaction_images'] as $img)
                                                            <div class="col-md-6">
                                                                <a href="{{$img}}" target="_blank">
                                                                    <img src="{{$img}}" width="200px" height="200px" class="m-2">
                                                                </a>
                                                            </div>
                                                            @endforeach
                                                        </div>
