...
<head>
    ...
    <title>Bill vault Transaction Receipt</title>
</head>
<body>
    @php
    ...
    <div style="display: flex;justify-content: space-between;align-items: center;">
         ...
         <div style="line-height: 20px;">
            <h1 style="font-size: 20px; margin-bottom: 0;">Airtime To Cash Receipt</h1>
    ...
    <div style="margin-top: 30px;">
        ...
        <div style="margin-bottom: 15px;">
            <p style="color:#747373; margin: 0;">Airtime Amount</p>
        ...
        <div style="margin-bottom: 15px;">
            <p style="color:#747373; margin: 0;">Network</p>
