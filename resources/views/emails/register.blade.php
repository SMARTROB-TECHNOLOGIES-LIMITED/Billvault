                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('assets/images/image-3.png') }}" alt="image"
                                                                            title="image"
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                ...
                                                                Dear customer, thank you for signing up with Billvault App.<br /><br />We received an account confirmation
                                                                request from your email address.</h1>
