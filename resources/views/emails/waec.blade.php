                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                ...
                                                                <strong>{{ $data['service_name'] }} </strong></h1>
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_button_1" style="font-family:'Raleway',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:14px 10px 22px;font-family:'Raleway',sans-serif; text-align: center;color: #000000; background-color: #fdb441; border-radius: 25px;"
                                                            align="left"> {{ $data['token'] }}
